...
SECRET_KEY = os.environ.get("SECRET_KEY") or config("SECRET_KEY", default="fallback-key")


# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config("DEBUG", default=False, cast=bool)

ALLOWED_HOSTS = ['https://protfolio.up.railway.app/', 'localhost', '127.0.0.1']
...
EMAIL_USE_TLS = os.environ.get('EMAIL_USE_TLS') == 'True' or config('EMAIL_USE_TLS', default=True)
